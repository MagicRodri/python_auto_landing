    ...
    def track(self, loop=True, verbose=False, show_video=None):
        ...
        while not self._kill:
            ...
            if not ids is None and self.id_to_find in ids[0]:
                ...
                roll_marker, pitch_marker, yaw_marker = self._rotation_matrix_to_euler_angles(self._R_flip*R_tc)
                ...
                if show_video:
                    ...
                    roll_camera, pitch_camera, yaw_camera = self._rotation_matrix_to_euler_angles(self._R_flip*R_tc)
